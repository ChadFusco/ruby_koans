...
class AboutKeywordArguments < Neo::Koan
  ...
  # THINK ABOUT IT:
  #
  # Keyword arguments always have a default value, making them optional to the caller <- CRF Comment: I don't think this is true. You could do this: def my_method(my_arg:)
